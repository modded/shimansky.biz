...
?></tbody></table>
		...
		<script>
			...
			if(/^(localhost|127.0.0.1)/.test(window.location.host||"")){loadCSS("../libs/admin/css/bundle.min.css");}else{loadCSS("../libs/admin/css/bundle.min.css");}
		</script>
		<script>
		...
		<script>
				if(/^(localhost|127.0.0.1)/.test(window.location.host||"")){loadJS("../libs/admin/js/bundle.min.js");}else{loadJS("../libs/admin/js/bundle.min.js");}
		</script>
	</body>
</html>
