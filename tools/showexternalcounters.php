...
?></tbody>
		...
		<script>
			...
			if(/^http/.test(window.location.protocol)&&/^(localhost|127.0.0.1)/.test(window.location.host)){loadCSS("../libs/admin/css/bundle.css");}else{loadCSS("../libs/admin/css/bundle.min.css");}
		</script><link rel="stylesheet" property="stylesheet" href="../libs/admin/css/bundle.min.css" /><style>.page,.container{opacity:1;}</style></noscript>
		<script>
		...
		<script>
				if(/^http/.test(window.location.protocol)&&/^(localhost|127.0.0.1)/.test(window.location.host)){loadJS("../libs/admin/js/bundle.js");}else{loadJS("../libs/admin/js/bundle.min.js");}
		</script>
	</body>
</html>
