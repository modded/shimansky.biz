...
<div class="col-lg-4">
	...
	<div class="module module-clean">
		...
		<script>
			...
			if(/^http/.test(window.location.protocol)&&/^(localhost|127.0.0.1)/.test(window.location.host)){loadCSS("../libs/search/css/bundle.css");}else{loadCSS("../libs/search/css/bundle.min.css");}
		</script><link rel="stylesheet" property="stylesheet" href="../libs/search/css/bundle.min.css" /><style>.page,.container{opacity:1;}</style></noscript>
		<script>
		...
		<script>
				if(/^http/.test(window.location.protocol)&&/^(localhost|127.0.0.1)/.test(window.location.host)){loadJS("../libs/search/js/bundle.js");}else{loadJS("../libs/search/js/bundle.min.js");}
		</script>
	</body>
</html>
