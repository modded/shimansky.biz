...
<html lang="ru">
	...
	<body>
		...
		<script>
			...
			if(/^(localhost|127.0.0.1)/.test(window.location.host||"")){loadCSS("../libs/search/css/bundle.min.css");}else{loadCSS("../libs/search/css/bundle.min.css");}
		</script>
		<script>
		...
		<script>
				if(/^(localhost|127.0.0.1)/.test(window.location.host||"")){loadJS("../libs/search/js/bundle.min.js");}else{loadJS("../libs/search/js/bundle.min.js");}
		</script>
	</body>
</html>
